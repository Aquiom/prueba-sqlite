  ...
  return (
    <SafeAreaView style={styles.container}>
      <View style={styles.phoneFrame}>
        <Text style={styles.titulo}>Tareas Angel Martinez</Text>
...
const styles = StyleSheet.create({
  ...
  boton: { backgroundColor: "#00ff11", borderRadius: 10, paddingHorizontal: 16, justifyContent: "center" },
  ...
  checkboxOn: { backgroundColor: "#00ffff", borderColor: "#00bfff" },
